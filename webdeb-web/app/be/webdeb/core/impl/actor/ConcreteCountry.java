...
/**
 * This class implements the Country interface
 *
 * @author Fabian Gilson
 * @author Martin Rouffiange
 */
class ConcreteCountry extends AbstractPredefinedStringValue implements Country {

  ConcreteCountry(String code, Map<String, String> i18names) {
    super(code, i18names);
  }
