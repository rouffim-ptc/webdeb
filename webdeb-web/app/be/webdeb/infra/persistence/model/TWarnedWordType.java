...
/**
 * The persistent class for the t_warned_word_context_type database table, holding predefined values for type of warned word
 *
 * @author Martin Rouffiange
 * @see TWarnedWord
 */
@Entity
@Table(name = "t_warned_word_type")
@CacheBeanTuning
@Unqueryable
public class TWarnedWordType extends TechnicalTable {

  /**
   * Finder to access predefined values
   */
  public static final Model.Finder<Integer, TWarnedWordType> find = new Model.Finder<>(TWarnedWordType.class);
