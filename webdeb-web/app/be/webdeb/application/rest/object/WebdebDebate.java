...
/**
 * This class is devoted to exchange Debates in JSON format. Enumerated (predefined) data are passed as
 * typed objects with their ids and i18n descriptions.
 *
 * @author Martin Rouffiange
 */
@JsonInclude(JsonInclude.Include.NON_EMPTY)
public class WebdebDebate extends WebdebContribution {
    ...
    /**
     * this argument type (full object with names) of the first debate argument
     */
    @JsonSerialize
     ...
     * @apiVersion 0.0.3
     */
    public WebdebDebate(Debate debate) {
        super(debate);
        title = debate.getFullTitle();
    }
}
