...
viz.debate.position.4.0=$Tout à fait d''accord
viz.debate.position.4.1=$Plutôt d''accord
viz.debate.position.4.2=$Indécis (peut-être ou ne sait pas)
viz.debate.position.4.3=$Pas d''accord
viz.debate.position.4.4=$Pas dutout d''accord

viz.debate.position.5.0=$Tout à fait d''accord
viz.debate.position.5.1=$Plutôt d''accord
viz.debate.position.5.2=$Indécis (peut-être ou ne sait pas)
viz.debate.position.5.3=$Pas d''accord
viz.debate.position.5.4=$Pas dutout d''accord

viz.debate.position.6.0=$Tout à fait d''accord
viz.debate.position.6.1=$Plutôt d''accord
viz.debate.position.6.2=$Indécis (peut-être ou ne sait pas)
viz.debate.position.6.3=$Pas d''accord
viz.debate.position.6.4=$Pas dutout d''accord

viz.debate.position.7.0=$Tout à fait d''accord
viz.debate.position.7.1=$Plutôt d''accord
viz.debate.position.7.2=$Indécis (peut-être ou ne sait pas)
viz.debate.position.7.3=$Pas d''accord
viz.debate.position.7.4=$Pas dutout d''accord

viz.debate.position.-1.0=$Tout à fait d''accord
viz.debate.position.-1.1=$Plutôt d''accord
viz.debate.position.-1.2=$Indécis (peut-être ou ne sait pas)
viz.debate.position.-1.3=$Pas d''accord
viz.debate.position.-1.4=$Pas dutout d''accord
...
viz.context.arguments.3.0=$Pour
viz.context.arguments.3.1=$Contre

viz.context.arguments.4.0=$Pour
viz.context.arguments.4.1=$Contre

viz.context.arguments.5.0=$Pour
viz.context.arguments.5.1=$Contre

viz.context.arguments.6.0=$Pour
viz.context.arguments.6.1=$Contre

viz.context.arguments.7.0=$Pour
viz.context.arguments.7.1=$Contre
...
#teach
teach.d1.title=$WebDeb, un outil pédagogique tous terrai
teach.d1.p1=$WebDeb a été conçu pour être utilisé en classe ou en formation. La plateforme permet  en  effet  de  faire  réfléchir  un  groupe  de  manière  rigoureuse  sur n’importe quel type de débat en facilitant l’encodage systématique et collaboratif des prises de position et des arguments ainsi que des CV des parties prenantes du débat.
teach.d1.p2=$En plus de développer ainsi des compétences de recherche et d’analyse documentaire, WebDeb permet, par la structuration des données, de servir d’assise à un travail de compréhension du débat, voire à une prise de position informée.
teach.d1.p3=$Les atouts de la plateforme sont nombreux. WebDeb permet en effet de :
teach.d1.p4=$<ul> \
    <li><b>Systématiser et standardiser </b>les données encodées ;</li> \
    <li><b>garder en mémoire </b>les analyses effectuées ;</li> \
    <li><b>mettre en commun</b> les travaux de plusieurs sous-groupes ;</li> \
    <li><b>modifier facilement </b> les données encodées et les organiser progressivement ;</li> \
    <li><b>travailler en distanciel </b>;</li> \
    <li><b>créer des groupes </b>pédagogiques privés ;</li> \
    <li><b>corriger aisément</b> les contributions.</li> \
</ul>
teach.d1.a1=$Découvrir et télécharger les tutoriels

teach.d2.title=$Débagora : un outil pédagogique mobilisant WebDeb
